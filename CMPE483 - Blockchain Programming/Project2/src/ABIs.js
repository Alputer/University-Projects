export const myGovABI = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract USD_Stable_Coin",
        name: "",
        type: "address",
      },
    ],
...
export const USD_Stable_Coin_ABI = [
  {
    inputs: [
      {
        internalType: "uint256",
